...
using SuperM.Redis.Configuration;
using System;
...
namespace SuperM.Redis.Repositories
{
    public class RedisRepository : IRedisRepository
    {
        ...
        /// 创建链接池管理对象
        /// </summary>
        private PooledRedisClientManager CreateManager(long dbId)
        {
            string[] writeServerList = SplitString(RedisConfiguration.WriteServerList, ",");
            string[] readServerList = SplitString(RedisConfiguration.ReadServerList, ",");

            return new PooledRedisClientManager(readServerList, writeServerList,
                             new RedisClientManagerConfig
                             {
                                 MaxWritePoolSize = RedisConfiguration.MaxWritePoolSize,
                                 MaxReadPoolSize = RedisConfiguration.MaxReadPoolSize,
                                 AutoStart = RedisConfiguration.AutoStart,
                                 DefaultDb = dbId
                             });
        }
        /// <summary>
        ...
        /// <returns></returns>
        private PooledRedisClientManager GetClientManager(long dbId)
        {
